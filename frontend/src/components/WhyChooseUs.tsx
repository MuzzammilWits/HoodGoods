    ...
    <section id="about-us" className="why-choose-us-container">
      <main className="container">
        ...
        <section className="trust-icons-section">
            <h2 className="common-section-heading">Our Impact</h2>
            <ul className="trust-icons-grid">
                <li className="trust-icon-item">
                    <figure className="trust-icon">
