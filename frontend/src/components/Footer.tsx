  ...
  return (
    <footer className="footer">
      ...
      <section className="footer-main">
        ...
        <div className="footer-content-row">
          ...
          <section className="footer-social-area">
            <nav className="social-icons" aria-label="Social Links">
              {/* By the way, the link you're using is a classic "Rick Roll"! You'll probably want to replace it with your actual social media links. */}
          ...
          <nav className="footer-links-area" aria-label="Footer Links">
        ...
        <p className="copyright">Copyright ©HoodsGoods</p>
      </section>
    </footer>
  );
};
