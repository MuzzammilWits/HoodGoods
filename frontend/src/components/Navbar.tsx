      ...
      <div className="navbar-container">
        ...
        <ul className="nav-menu">
          <li className="nav-item">
            <Link to="/" className="nav-link">Home</Link> {/* Updated */}
          </li>
          <li className="nav-item">
            <Link to="#featured-products" className="nav-link">Products</Link>
          </li>
          <li className="nav-item">
